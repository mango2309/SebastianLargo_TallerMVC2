...
namespace SebastianLargo_TallerMVC2.Controllers
{
    public class BurgersController : Controller
    {
        private readonly SebastianLargo_TallerMVC2Context _context;

        public BurgersController(SebastianLargo_TallerMVC2Context context)
        {
            _context = context;
        }
